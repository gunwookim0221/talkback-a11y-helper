...
TAB_CONFIGS = [
    ...
    },
    {
        ...
        "pre_navigation": [
            {
                "action": "enter_device_card_plugin",
                "target": "모션센서",
                "target_stable_labels": ["모션센서", "Motion sensor"],
                "max_scroll_search_steps": 4,
            }
        ],
        "anchor_name": "(?i).*(navigate\\s*up|상위\\s*메뉴로\\s*이동).*",
        ...
        "context_verify": {
            "type": "screen_text",
            "text_regex": "(?i).*모션센서.*|.*motion\\s*sensor.*",
        },
        "enabled": False,
        "max_steps": 40,
    },
    ...
    },
    {
        ...
        "pre_navigation": [
            {
                "action": "enter_device_card_plugin",
                "target": "공기청정기",
                "target_stable_labels": ["공기청정기", "Air purifier"],
                "max_scroll_search_steps": 4,
            }
        ],
        "anchor_name": "(?i).*(navigate\\s*up|상위\\s*메뉴로\\s*이동).*",
        ...
        "context_verify": {
            "type": "screen_text",
            "text_regex": "(?i).*공기청정기.*|.*air\\s*purifier.*",
        },
        "enabled": False,
        "max_steps": 40,
    },
        ...
        "pre_navigation": [
            {
                "action": "enter_device_card_plugin",
                "target": "세탁기",
                "target_stable_labels": ["세탁기", "Washer"],
                "max_scroll_search_steps": 4,
            }
        ],
        "anchor_name": "(?i).*(navigate\\s*up|상위\\s*메뉴로\\s*이동).*",
    ...
    {
        "scenario_id": "device_temperature_humidity_sensor_plugin",
        "scenario_type": "content",
        "entry_type": "card",
        "tab_name": "(?i).*devices.*",
        "tab_type": "b",
        ...
        "pre_navigation": [
            {
                "action": "enter_device_card_plugin",
                "target": "온습도 센서",
                "target_stable_labels": ["온습도 센서", "Temperature & humidity sensor"],
                "max_scroll_search_steps": 4,
            }
        ],
        "anchor_name": "(?i).*(navigate\\s*up|상위\\s*메뉴로\\s*이동).*",
        ...
        "context_verify": {
            "type": "screen_text",
            "text_regex": "(?i).*온습도\\s*센서.*|.*temperature.*humidity.*sensor.*",
        },
        "enabled": False,
        "max_steps": 40,
    },
    {
        ...
        "context_verify": {
            "type": "screen_text",
            "text_regex": "(?i)^camera$|.*\\bcamera\\b.*",
        },
        "enabled": False,
        "max_steps": 40,
    },
    {
        "scenario_id": "device_home_camera_plugin",
        "scenario_type": "content",
        "entry_type": "card",
        "tab_name": "(?i).*devices.*",
        "tab_type": "b",
        ...
        "context_verify": {
            "type": "screen_text",
            "text_regex": "(?i).*홈카메라\\s*360.*|.*home\\s*camera\\s*360.*",
        },
        "enabled": False,
        "max_steps": 40,
    },
