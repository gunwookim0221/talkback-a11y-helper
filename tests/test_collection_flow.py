...
def test_select_visible_plugin_candidate_infers_title_hidden_card_from_structure_evidence():
    nodes = [
        {
            "text": "Life",
            "boundsInScreen": "0,0,1080,2200",
            ...
            "children": [
                {
                    "boundsInScreen": "100,580,980,1100",
                    "visibleToUser": True,
                    "clickable": True,
                    "focusable": False,
                    "viewIdResourceName": "com.test:id/preInstalledServiceCard",
                    ...
                    "children": [
                        {
                            "text": "Upcoming meal",
                            "boundsInScreen": "180,700,820,760",
                            "visibleToUser": True,
                            "viewIdResourceName": "com.test:id/tvHeaderTitle",
                            "className": "android.widget.TextView",
                        },
                        {
                            "text": "Chef's pasta recipe",
                            "boundsInScreen": "180,780,920,860",
                            "visibleToUser": True,
                            "viewIdResourceName": "com.test:id/tvCardDescription",
                            "className": "android.widget.TextView",
                        },
                        {
                            "boundsInScreen": "180,880,920,1060",
                            "visibleToUser": True,
                            "viewIdResourceName": "com.test:id/bodyImage",
                            "className": "android.widget.ImageView",
                        },
                        {
                            "boundsInScreen": "520,1068,560,1088",
                            "visibleToUser": True,
                            "viewIdResourceName": "com.test:id/pagerIndicatorDot",
    ...
    selected, reason, stats, selected_meta = collection_flow._select_visible_plugin_candidate(
        ...
        entry_spec={
            "title_patterns": [r"(?i)(^food$|food\.|smart\s*things\s*cooking|\bcooking\b)"],
            "description_patterns": [r"(?i)(smart\s*things\s*cooking|\bcooking\b)"],
            "resource_patterns": [r"(?i)(preinstalledservicecard|servicecard|card|container|tvheadertitle|bodyimage|indicator|pager|dot)"],
            "allow_description_match": True,
...
def test_select_visible_plugin_candidate_does_not_infer_title_hidden_card_without_image_evidence():
    nodes = [
        {
            "text": "Life",
            "boundsInScreen": "0,0,1080,2200",
            ...
            "children": [
                {
                    "boundsInScreen": "100,580,980,980",
                    "visibleToUser": True,
                    "clickable": True,
                    "focusable": False,
                    "viewIdResourceName": "com.test:id/preInstalledServiceCard",
    ...
    assert selected is None
    assert reason == "no_visible_candidate"
    assert stats.get("visible_candidate_count", 0) == 0
