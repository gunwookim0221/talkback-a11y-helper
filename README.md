...
- `A11yNavigator`
  - 알고리즘 버전: `NAVIGATOR_ALGORITHM_VERSION = 2.26.0`
  ...
  - scroll 이후 후보 선택은 anchor(이전 포커스 bounds.bottom) 기반으로 `node.top > anchorBottom`인 첫 본문 후보를 우선 선택해 top jump(예: SmartThings 상단 복귀)를 방지
