...
- `A11yNavigator`
  ...
  - `A11yHelperService.VERSION = 1.0.1`: `TOUCH_BOUNDS_CENTER` 제스처 디스패치 안정화를 위해 tap duration(50ms), main looper callback handler, timeout 구분(reason 세분화), gesture 직전 짧은 안정화 대기(80ms)를 적용했습니다.
