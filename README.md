...
- `A11yNavigator`
  - 알고리즘 버전: `NAVIGATOR_ALGORITHM_VERSION = 2.29.0`
  ...
  - 위 `<no-label>` continuation 후보는 descendant readable text를 재수집해 라벨 복구를 시도하며, 복구 시 `[SMART_NEXT] Resolved descendant label for continuation target: ...` 로그를 남김 (예: `Labs`)
