...
- `A11yNavigator`
  ...
  - `A11yHelperService.VERSION = 1.0.2`: `TOUCH_BOUNDS_CENTER` 제스처 디스패치 안정화를 위해 tap duration(90ms), main looper callback handler, timeout을 2800ms로 완화한 callback 분기(reason 세분화), gesture 직전 짧은 안정화 대기(100ms)를 적용했습니다.
