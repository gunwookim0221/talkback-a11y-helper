...
- Scenario presets only change checkbox selection. Smoke/Full buttons choose the execution mode.
...
- Presets only change the current checkbox selection. They do not change Smoke/Full mode and do not edit `config/runtime_config.json`.
