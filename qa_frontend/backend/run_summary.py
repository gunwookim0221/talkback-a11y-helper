...
def build_run_summary(
    *,
    ...
    return {
        ...
        "special_state_handled_scenarios": int(parsed.get("special_state_handled_scenarios") or 0),
        ...
        "scenario_passed_count": int(parsed.get("passed_scenarios") or 0),
        "scenario_warning_count": int(parsed.get("warning_scenarios") or 0),
        "scenario_completed_count": int(parsed.get("completed_scenarios") or 0),
        "scenario_executed_count": int(parsed.get("executed_scenarios") or 0),
        "scenario_not_available_count": int(parsed.get("not_available_scenarios") or 0),
        "scenario_availability_candidate_count": int(parsed.get("availability_candidate_scenarios") or 0),
        "scenario_failed_count": int(parsed.get("failed_scenarios") or 0),
