...
기준일: 2026-07-13
기본 동작: `TB_TRAVERSAL_IDENTITY_V2_ENABLED` OFF
범위: production progress/visit/consumption/stop/recovery의 opt-in evidence gate
...
1. run-scoped traversal flag ON
...
- Traversal Identity V2는 run-scoped experimental feature flag이며 기본값은 아직 OFF다.
